...
foreach var in mean variance skew kurt {	
	...
	note("Notes: This figure shows the `var' of standardized Haltiwanger growth rates of sales by size (left)" ///
		 "and age (right) class on Belgian VAT data from 1995 to 2017. Each line in the graphs by size represents" ///
		 "a different age class and vice versa. The dotted line represents the mean across these lines. Growth" ///
		 "rates are standardized by the growth rate of total sales in the economy.", size(small) pos(6) justification(left))
