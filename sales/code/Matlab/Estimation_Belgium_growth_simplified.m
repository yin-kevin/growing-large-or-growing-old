...
clear
clc
cd 'D:\Kevin\Firm_Growth_Project\_Final\Sales\Data'

% location of code
addpath('D:\Kevin\Firm_Growth_Project\_Final\Sales\Code\Matlab')

% for using functions
addpath('D:\Kevin\Firm_Growth_Project\_Final\Sales\Code\Matlab\functions')

% for storing results
addpath('D:\Kevin\Firm_Growth_Project\_Final\Sales\Estimation\growth_simplified')
rng default;
...
writetable(allresults_ordered(1:5,:), 'D:\Kevin\Firm_Growth_Project\_Final\Sales\Estimation\growth_simplified\Belgium_growth_simplified_estimates.csv')

%% 7) Show model fit

% Best estimates from simplified growth model
rho_u_fit=table2array(allresults_ordered(1,2));
sigma2_e_fit=table2array(allresults_ordered(1,3));
sigma2_z_fit=table2array(allresults_ordered(1,4));
psi_fit=table2array(allresults_ordered(1,5));
...
title("Model fit: Belgian Data, growth (simplified model)")
saveas(gcf,'D:\Kevin\Firm_Growth_Project\_Final\Sales\Estimation\growth_simplified\ModelFit_Belgium_growth_simplified.png')
