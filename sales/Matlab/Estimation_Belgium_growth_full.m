...
% for storing results
addpath('D:\Kevin\Firm_Growth_Project\_Final\Sales\Estimation\growth_full')
rng default;
...
writetable(allresults_ordered(1:5,:), 'D:\Kevin\Firm_Growth_Project\_Final\Sales\Estimation\growth_full\Belgium_growth_full_estimates.csv')
...
title("Model fit: Belgian Data, growth (full model)")
saveas(gcf,'D:\Kevin\Firm_Growth_Project\_Final\Sales\Estimation\growth_full\ModelFit_growth_full.png')
