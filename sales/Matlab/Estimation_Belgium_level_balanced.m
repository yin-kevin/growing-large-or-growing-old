...
% for storing results
addpath('D:\Kevin\Firm_Growth_Project\_Final\Sales\Estimation\level_balanced')
rng default;
...
writetable(allresults_ordered(1:5,:), 'D:\Kevin\Firm_Growth_Project\_Final\Sales\Estimation\level_balanced\Belgium_level_balanced_estimates.csv')
...
saveas(gcf,'D:\Kevin\Firm_Growth_Project\_Final\Sales\Estimation\level_balanced\ModelFit_Belgium_level_balanced.png')
end
