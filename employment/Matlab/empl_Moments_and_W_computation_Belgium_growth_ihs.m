...
data=readmatrix('D:\Kevin\Firm_Growth_Project\_Final\Employment\Data\clean\reshaped\empl_new_vat_data_reshaped_growth_ihs.csv');
data=data(:,2:end);
%% 2) Study missing values in the dataset and does some plots on firm demographics
...
save('matlab\C_growth_ihs.mat','C')
...
save('matlab\W_boot_growth_ihs.mat','W_boot')
