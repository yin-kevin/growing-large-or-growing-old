...
% 1) Loads data of firm log size from "new_vat_data_reshaped_level_balanced.csv"
...
% 3) Computes vector C_level_balanced (correlation of levels across ages)

% 4) Computes weighting matrix W_boot_level_balanced with bootstrap
...
data=readmatrix('D:\Kevin\Firm_Growth_Project\_Final\Employment\Data\clean\reshaped\empl_new_vat_data_reshaped_balanced.csv');
data=data(:,2:end);
%% 2) Study missing values in the dataset and does some plots on firm demographics
% 
...
T=95; % number of ages considered (there are only 95 years)
...
save('matlab\C_level_balanced.mat','C')
...
save('matlab\W_boot_level_balanced.mat','W_boot')
